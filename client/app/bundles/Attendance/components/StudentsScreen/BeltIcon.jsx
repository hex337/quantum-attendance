...
export default class BeltIcon extends BaseComponent {
  static propTypes = {
  ...
  render() {
    ...
    const clsName = "belt-image " + name.replace(/ /g, "-").toLowerCase();

    return (
      <div key={id} className="belt-tile-container">
				<svg viewBox="0, 0, 100, 80" width={width} height={height} xmlns="http://www.w3.org/2000/svg" className={clsName}>
					 <g>
						<title>Layer 1</title>
